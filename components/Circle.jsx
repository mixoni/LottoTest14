...
componentDidMount(){
    ...
    if(this.state.className == "ball-circle" && currentScene === "RenderAnimationScene"){
        ...
        let drumInterval = 1000/28; // => 60 fps = 60 pictures/sec
        let $value = 0;
        ...
        let renderTimer = 0;// numbersInProgress !== null && numbersInProgress.length > 0 ? numbersInProgress.length * drumInterval + 50 : 50;  
        ...
        function renderDrum() {
            ...
            let rTimer = renderTimer < 1000 ? renderTimer < 100 ? renderTimer < 10 ? "000" + renderTimer : "00" + renderTimer : "0" + renderTimer : renderTimer;      
            ...
            let img = document.querySelector("img[src='./Images/Drum/LottoJPG_00" + rTimer + ".jpeg']");            
        ...
        let exLoop = setInterval(function() {
            ...
            if(counter > numbersArray.length - 1 || !elementToUpdate)
            {
                ...
                let img = document.querySelector("img[src='./Images/Drum/LottoJPG_003050.jpeg']");            
                img.className = "drum-images show";
                clearInterval(startRenderDrumAnimation);
...
Animation = () => {
   ...
   //console.log($this.state.angles);
    ...
    function initailRenderDrum() {            
        ...
        img.src = './Images/Drum/LottoJPG_00' + rTimer + '.jpeg';
